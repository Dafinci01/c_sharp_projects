...
class Program
{
    static void Main()
    {
        ...
        */
        ...
        // there should be a logic/database  where  days and month saved , the issue is am i the one to create it
        //or does c# has a inbuilt data base for it 

        switch (Monthnumber)
        {
            case "January":
                Console.WriteLine($"the days of the {"Monthnumber"} is {" "}");
        }
